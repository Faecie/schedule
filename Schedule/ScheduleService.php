...
class ScheduleService
{
     ...
     */
    public function findLastIterationsCollection(JobSchedule $task, $isSuccessful = null, $number = 1): array
    {
     ...
     * @throws RuntimeException
     */
    public function requireJobByName($commandClassName): Job
    {
     ...
     * @throws RuntimeException
     */
    public function requireJobById(int $jobId): JobSchedule
    {
        try {
     ...
     * @throws RuntimeException
     */
    public function requireJobScheduleExecutionById(int $execId): JobScheduleExecution
    {
        try {
            return $this->entityManager->createQueryBuilder()
                ->select('jse')
