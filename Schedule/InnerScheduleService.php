...
class InnerScheduleService
{
     ...
     * @return string
     */
    public function getCommandName(string $taskClassName): string
    {
        /** @var Command $command */
     ...
     */
    public function validateCommandClass(string $command): bool
    {
     ...
     */
    public function flushEntity($entity): void
    {
        try {
