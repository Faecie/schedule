...
class JobScheduleExecution extends AbstractJobSchedule
{
     ...
     */
    public function __construct(JobSchedule $jobSchedule, ?string $command = null)
    {
     ...
     * @return JobSchedule
     */
    public function getJobSchedule(): JobSchedule
    {
     ...
     * @return string
     */
    public function getLastResultInfo(): string
    {
     ...
     * @return void
     */
    public function setLastResultInfo(string $lastResultInfo): void
    {
     ...
     * @return int
     */
    public function calculateNextExecutionNumber(\DateTime $date = null): int
    {
